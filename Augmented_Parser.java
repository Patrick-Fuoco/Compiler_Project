...
public class Augmented_Parser extends ASTBuilder{
...
Augmented_Parser(){}
	...
	public Augmented_Parser(String File_path1, String File_path2) throws IOException{
...
public boolean STRUCTORIMPLORFUNC() {
	...
	if(lookahead.lexeme.equals("struct")) {
		...
		if(STRUCTDECL() && createSubtree("StructDecl", 1)) {
		...
		if(IMPLDEF() && createSubtree("ImplDef", 1)) {
		...
		if(FUNCDEF() && createSubtree("FuncDef", 4)) {
...
public boolean STRUCTDECL() {
	...
	if(lookahead.lexeme.equals("struct")) {
		...
		if(match("struct", lookahead.lexeme) && match("id",lookahead.lexeme,storage) && createLeaf(storage) && OPTSTRUCTDECL2() &&  match("{",lookahead.lexeme) && REPTSTRUCTDECL4() && match(";",lookahead.lexeme) &&  match("}",lookahead.lexeme) && createSubtree("StructDecl", 3)) {
...
public boolean OPTSTRUCTDECL2() {
	...
	if(lookahead.lexeme.equals("inherits")){
        StringBuilder storage = new StringBuilder();
		 if(match("inherits", lookahead.lexeme) && match("id",lookahead.lexeme,storage) && createLeaf(storage) && PUSH_EPSILON() && REPTOPTSTRUCTDECL22()){
...
public boolean FUNCHEAD() {
	if (!skipErrors(new HashSet<>(Arrays.asList("func")), new HashSet<>(Arrays.asList(";", "{")), lookahead))
	 ...
	 if(lookahead.lexeme.equals("func")) {
		StringBuilder storage = new StringBuilder();
		if(match("func", lookahead.lexeme) && match("id", lookahead.lexeme,storage) && createLeaf(storage) && match("(", lookahead.lexeme) && FPARAMS() && match(")", lookahead.lexeme) && match("->", lookahead.lexeme) && RETURNTYPE()) {
...
public boolean FPARAMS() {
	...
	if (!skipErrors(new HashSet<>(Arrays.asList("id", "EPSILON")), new HashSet<>(Arrays.asList(")")), lookahead))
	 ...
	 if(lookahead.type == Token.TokenType.id) {
		StringBuilder storage = new StringBuilder();
		if(match("id", lookahead.lexeme,storage) && PUSH_EPSILON() && createLeaf(storage) && match(":", lookahead.lexeme) && TYPE() && PUSH_EPSILON() && REPTFPARAMS3() && createSubtree("DimensionList", 0) && createSubtree("fparam", 3) && REPTFPARAMS4() && createSubtree("ParameterList", 0)) {
...
public boolean VARDECL() {
	...
	if(lookahead.lexeme.equals("let")){
		StringBuilder storage = new StringBuilder();
		if(match("let", lookahead.lexeme) && match("id", lookahead.lexeme,storage) && createLeaf(storage) && match(":", lookahead.lexeme) && TYPE() && PUSH_EPSILON() && REPTVARDECL4() && createSubtree("Dimensionlist",0) && match(";", lookahead.lexeme) && createSubtree("VarDecl", 3)) {
...
public boolean TYPE() {
	...
	if(lookahead.lexeme.equals("integer")) {
		if(match("integer", lookahead.lexeme) && createLeaf("integer")) {
		...
		if(match("float", lookahead.lexeme) && createLeaf("float")) {
			...
			StringBuilder storage = new StringBuilder();
			if(match("id", lookahead.lexeme,storage) && createLeaf(storage)) {
...
public boolean RETURNTYPE() {
	...
	if(lookahead.lexeme.equals("float") ||lookahead.lexeme.equals("integer") || lookahead.type == Token.TokenType.id) {
		...
		if(match("void", lookahead.lexeme) && createLeaf("void")) {
...
public boolean ARRAYSIZE2() {
	...
	if(lookahead.type == Token.TokenType.intlit){
		StringBuilder storage = new StringBuilder();
		if(match("intlit", lookahead.lexeme,storage) && createLeaf(storage) && match("]", lookahead.lexeme)){
...
public boolean REPTFPARAMS4() {
	...
	if(lookahead.lexeme.equals(",")) {
		if(PUSH_EPSILON() && FPARAMSTAIL() && createSubtree("fparam", 0) && REPTFPARAMS4()) {
...
public boolean FPARAMSTAIL() {
	if (!skipErrors(new HashSet<>(Arrays.asList(",")), new HashSet<>(Arrays.asList(",",")")), lookahead))
	 ...
	 if(lookahead.lexeme.equals(",")) {
		StringBuilder storage = new StringBuilder();
		if(match(",", lookahead.lexeme) && match("id", lookahead.lexeme,storage)&& createLeaf(storage) && match(":", lookahead.lexeme) && TYPE() && PUSH_EPSILON() && REPTFPARAMSTAIL4() && createSubtree("dimensionList",0)) {
...
public boolean FACTOR() {
	...
	if(lookahead.type == Token.TokenType.id) {
		StringBuilder storage = new StringBuilder();
		if(match("id", lookahead.lexeme,storage) && createLeaf(storage) && FACTOR2() && REPTVARORFUNCCALL()) {
		...
		StringBuilder storage = new StringBuilder();
		if(match("intlit", lookahead.lexeme,storage) && createLeaf(storage)){
		...
		StringBuilder storage = new StringBuilder();
		if(match("floatlit", lookahead.lexeme,storage) && createLeaf(storage)){
			System.out.println("FACTOR -> " + storage);
			 return true;
		}
		else
...
public boolean ASSIGNOP() {
	...
	if(lookahead.lexeme.equals("=")) {
		if(match("=", lookahead.lexeme) && createLeaf("=")) {
...
public boolean VARIABLE() {
	...
	if(lookahead.type == Token.TokenType.id) {
		StringBuilder storage = new StringBuilder();
		if(match("id", lookahead.lexeme,storage) && createLeaf(storage) && VARIABLE2()) {
			System.out.println("VARIABLE -> " + storage + "VARIABLE2");
			 return true;
		}
		else 
			return false;
...
public boolean STATEMENT() {
	...
	if(lookahead.lexeme.equals("if")){
		...
		StringBuilder storage = new StringBuilder();
		if(match("id", lookahead.lexeme,storage) && createLeaf(storage) && STATEMENTIDNEST() && match(";", lookahead.lexeme) && createSubtree("=", 2)){
		...
		if(match("while", lookahead.lexeme) && createLeaf("while") && match("(", lookahead.lexeme) && RELEXPR() && match(")", lookahead.lexeme)  && STATBLOCK() && match(";", lookahead.lexeme) && createSubtree("while", 2)) {
...
public boolean RELEXPR() {
	...
	if(lookahead.type == Token.TokenType.id || lookahead.type == Token.TokenType.intlit || lookahead.type == Token.TokenType.floatlit || lookahead.lexeme.equals("(") || lookahead.lexeme.equals("!") || lookahead.lexeme.equals("+") || lookahead.lexeme.equals("-")) {
		...
		if(ARITHEXPR() && RELOP() && ARITHEXPR() && createSubtree(relop_tracker, 2)) {
